...
const ChatHistorySidebar: React.FC<ChatHistorySidebarProps> = ({
	...
	return (
		...
		>
			...
			{/* ========================================================================= */}
			{/* Konten ini sekarang yang akan flex-grow dan memiliki scrollbar jika diperlukan, 
			    memastikan Wave Animation tetap di bawahnya. */}
            ...
            {/* Akhir Konten Sidebar - SCROLLABLE AREA */}
