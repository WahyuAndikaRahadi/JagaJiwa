...
// GANTI NAMA IMPORT DARI WaveDivider ke StyledPathWithLeaves
  ...
  return (
    <div className="border-b border-gray-200 dark:border-gray-700">
      ...
      >
        {question}
        <ChevronDown
          className={`w-5 h-5 transition-transform duration-300 ${isOpen ? "rotate-180 text-[#1ff498]" : ""
            }`}
        />
      </button>
      <div
...
// === Komponen Utama: Home ===
function Home() {
  // --- State dan Fungsi Testimonial Slider (Tetap Sama) ---
  ...
  // === Ref untuk Mengamati Visibilitas (In View) (Tetap Sama) ===
  ...
  return (
    ...
    >
      {/* === Background Blobs (MODIFIKASI: SEMUA BLUR DIHAPUS, DIGANTI BOLA-BOLA KECIL) === */}
      {/* Ini hanya untuk placeholder, nanti akan banyak diisi motion.div di bawah */}
      ...
      {/* === ORNAMEN TAMBAHAN AESTHETIC DENGAN FRAMER MOTION (MEMPERBANYAK BOLA-BOLA) === */}
      <div className="absolute inset-0 z-[1] pointer-events-none">
        {/* Ornamen 1: Hero Area - Orb besar, sedang, kecil */}
        <motion.div
        ...
        {/* Ornamen area tengah (Filosofi/Fitur) */}
        <motion.div
        ...
        {/* Ornamen Pattern Titik Estetik (Tidak berubah) */}
        <div
      ...
      {/* === AKHIR ORNAMEN TAMBAHAN ESTHETIC === */}

      {/* Kontainer Hero Section (dengan batasan lebar) */}
      ...
      {/* AKHIR: Kontainer Hero Section */}

      {/* StyledPathWithLeaves PERTAMA - FULL WIDTH */}
      <StyledPathWithLeaves className="my-20 w-full" />

      {/* Kontainer untuk Filosofi dan Fitur (dengan batasan lebar) */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-9 relative z-10">

        {/* === Filosofi Kami (MODIFIKASI: Dikembalikan dengan Quote Estetik) === */}
        <motion.div
          ref={philosophyRef}
          variants={fadeInUp}
          initial="initial"
        ...
        >
          ...
          >
            {/* Decorative Elements (blur-sm dihapus) */}
            ...
            {/* Quote Content (Paragraf Filosofi Asli dengan Gradien) */}
            <div className="relative z-10">
              <p className="text-xl md:text-2xl lg:text-3xl font-medium px-6 md:px-10 leading-relaxed">
                ...
                <span className="text-gray-900 dark:text-gray-100"> adalah perjalanan, bukan tujuan. Jaga Jiwa berkomitmen menjadi pendamping digitalmu yang andal, aman, dan tanpa penghakiman. Kami percaya setiap individu berhak mendapatkan dukungan terbaik untuk mencapai{" "}</span>
              ...
              {/* Author (Opsional, jika ingin menambahkan) */}
          ...
          <div className="flex flex-wrap justify-center gap-6 text-lg font-semibold mt-10"> {/* Tambahkan mt-10 agar tidak terlalu dekat dengan quote */}
...
{/* AKHIR: Kontainer Artikel & FAQ */}
      ...
      {/* Kontainer untuk Testimoni dan CTA (dengan batasan lebar) */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-9 relative z-10">
        ...
        <section ref={testimonialsRef} className="mb-24 pt-10">
          ...
          >
            ...
            <p className="mb-6 text-lg text-emerald-700 dark:text-emerald-300">
              Ingin tahu bagaimana Jaga Jiwa membantu ratusan orang menemukan ketenangan?
              Kunjungi bagian Tentang Kami dan kenali lebih dalam perjalanan ini.
            </p>
            <a
              href="/about"
